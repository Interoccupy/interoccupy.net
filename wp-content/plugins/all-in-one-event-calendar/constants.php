...
function ai1ec_initiate_constants() {
	...
	if ( ! defined( 'AI1EC_THEMES_VERSION' ) ) {
		define( 'AI1EC_THEMES_VERSION',     '19-pro' );
	}
	...
	if ( ! defined( 'AI1EC_UPDATES_URL' ) ) {
		define( 'AI1EC_UPDATES_URL',        'http://time.ly/latest-pro-version.json' );
	}
	...
	if ( ! defined( 'AI1EC_LICENSE_STATUS_JS' ) ) {
		define(
			...
			'https://api.time.ly/check_license_status.js?license=' .
			AI1EC_TIMELY_SUBSCRIPTION . '&version='.floatval( AI1EC_VERSION )
		);
	}
